...
class TradeFundBillRepositoryTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = new TradeFundBillRepository($this->registry);
    }
    ...
    {
        $this->assertInstanceOf(TradeFundBillRepository::class, $this->repository);
    }
}