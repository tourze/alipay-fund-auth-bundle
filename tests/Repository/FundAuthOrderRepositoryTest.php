...
class FundAuthOrderRepositoryTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = new FundAuthOrderRepository($this->registry);
    }
    ...
    {
        $this->assertInstanceOf(FundAuthOrderRepository::class, $this->repository);
    }
}