...
class FundAuthUnfreezeLogRepositoryTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = new FundAuthUnfreezeLogRepository($this->registry);
    }
    ...
    {
        $this->assertInstanceOf(FundAuthUnfreezeLogRepository::class, $this->repository);
    }
}