...
class TradeExtendParamsRepositoryTest extends TestCase
{
    private TradeExtendParamsRepository $repository;
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = new TradeExtendParamsRepository($this->registry);
    }
    ...
    {
        $this->assertInstanceOf(TradeExtendParamsRepository::class, $this->repository);
    }
}