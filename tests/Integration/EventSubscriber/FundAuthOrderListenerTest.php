...
class FundAuthOrderListenerTest extends TestCase
{
    private SdkService $sdkService;
    private FundAuthOrderListener $listener;

    protected function setUp(): void
    {
        $this->sdkService = $this->createMock(SdkService::class);
        $this->listener = new FundAuthOrderListener($this->sdkService);
    }
    ...
    {
        $this->assertInstanceOf(FundAuthOrderListener::class, $this->listener);
    }
